...
//Map backend batch to frontend batch
export function mapBackendBatch(backendBatch: BackendBatch): Batch {
    return {
        ...
        config: {
            ...
            confidence_threshold_high: 0.8, //Default value
            confidence_threshold_medium: 0.6, //Default value
            max_processing_time: 300, //Default value
            retry_failed_items: true, //Default value
            priority: 'normal', //Default value
        },
        created_at: backendBatch.created_at,
        started_at: backendBatch.created_at, //Assumed to start immediately
